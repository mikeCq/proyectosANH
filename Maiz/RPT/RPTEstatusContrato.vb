...
Public Class RPTEstatusContrato
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Maiz.RPTEstatusContrato.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IdEstatus() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPTEstatusContrato
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTEstatusContrato = New RPTEstatusContrato()
        rpt.Site = Me.Site
        Return rpt
    End Function
